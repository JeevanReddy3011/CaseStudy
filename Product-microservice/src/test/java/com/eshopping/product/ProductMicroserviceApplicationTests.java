...
class ProductApplicationTests {
	...
	@Test
	void testAddProduct() {
		Product product =  new Product(1,"Google Pixel",60000.0,"available","mobile","a mobile","img");
	...
	void testGetAllProducts() {
		Mockito.when(productRepository.findAll()).thenReturn(Stream.of(
				new Product(1,"Google Pixel",60000.0,"available","mobile","a mobile","img"),
				new Product(1,"Pant",2000.0,"available","jeans","Jeans","img"))
